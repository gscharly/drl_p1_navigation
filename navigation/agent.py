...
# Adapted from https://github.com/udacity/deep-reinforcement-learning/blob/master/dqn/solution/agent.py
class DQNAgent:
    ...
    def step(self, state: np.ndarray, action: int, reward: int, next_state: int, done: bool):
